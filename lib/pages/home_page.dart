              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                   ...
                   const VerticalDivider(width: 3,color: Colors.black38, indent: 3,),
                    _customeRows("10", "My Points", Icons.start_outlined)
                  ],
                ),
              ),
              ],
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Divider(height: 3,color: Colors.black38,),
                  Container(
                  padding:const EdgeInsets.all(12),
                  child: Row(
                    children: const [
                ...
                Container(
                  ...
                  child: const Center(child: Text("Search",style: TextStyle(
                    color: Colors.white,
                    fontSize: 14
                  ),)),
                )
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Icon(icon,color: Colors.pink.shade900,),
                  ),
                  Container(
